  ...
  return (
    <div className="min-h-screen bg-zinc-50 px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border border-zinc-200 rounded-xl p-6 sm:p-8 shadow-sm space-y-8">
          <div>
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-semibold text-zinc-900">3. Payments</h2>
            <p className="text-sm text-zinc-600">
          ...
          <section className="space-y-2">
            <h2 className="text-sm font-semibold text-zinc-900">6. Contact</h2>
            <p className="text-sm text-zinc-600">
